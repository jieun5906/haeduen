 ...
 */
 $(document).ready(function(){
    ...
    /*$('.xans-layout-category li').mouseenter(function(e) {
     ...
     $('.xans-layout-category li i').on('click', function(e) {
         var $this = $(this).parent('.xans-layout-category li').toggleClass('on');
         var $this02 = $(this).toggleClass('active');
         var iCateNo = Number(methods.getParam($this.find('a').attr('href'), 'cate_no'));
         if (!iCateNo) {
               return;
          }
         
         if($($this).find('div').hasClass("sub-category")){
